                        ...
                        <aside class="widget" style="margin-top: 18px;">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <table class="table">
                                        ...
                                        @if ($service->discount)
                                            ...
                                            @elseif ($service->discount == 'percent')
                                                <tr>
                                                    <td>Discount</td>
                                                    <td>{{$service->discount}}%</td>
                                                    @php
                                ...
                                <div class="panel-footer">
                                    @auth
                                        <a href="{{route('home.choose_sprovider',['service_id'=>$service->id])}}" class="btn btn-primary">Book Now</a>
                                    @else
                                        <div class="toggle_info">
                                            <span>
                                                <i class="fi-rs-user mr-10"></i>
                                                <span class="text-muted">Already have an account?</span>
                                                <a href="{{route('login')}}" data-bs-toggle="collapse" class="collapsed" aria-expanded="false">Click here to login</a>
                                            </span>
                                        </div>
                                    @endauth
