                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <aside>
                                ...
                                <h4>The Office</h4>
                                <address>
                                    <strong>TechConnect Home Services.</strong><br>
                                    <i class="fa fa-map-marker"></i>
                                    @if (Session::has('city'))
                                        <strong>Address: </strong>{{Session::get('city')}}, {{Session::get('state')}}
                                    @else
                                        <strong>Address: </strong>Tetouan, Maroc
                                    @endif
                                    <br>
                                    <i class="fa fa-phone"></i>
                                    <strong>Phone: </strong> +212 666 666 666
                                </address>
                                <address>
                                    <strong>TechConnect Emails</strong><br>
                                    <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                        href="mailto:contact@techconnect.in"> contact@techconnect.in</a><br>
                                    <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                        href="mailto:support@techconnect.in"> support@techconnect.in</a>
                                </address>
                            </aside>
                            <hr class="tall">
                        </div>
