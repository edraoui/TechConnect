    ...
    <section class="tp-banner-container">
        ...
        <div class="filter-title">
            ...
            <div class="filter-header">
                <form id="sform" action="{{route('searchServices')}}" method="get">
                    @csrf
        ...
        <div class="content_info">
            <div>
                <div class="container">
                    <div class="row">
                        <div class="titles">
                            <h2>TechConnect <span>Choice</span> of Services</h2>
                                ...
                                <a class="g-list" href="{{route('home.service_details',['service_slug'=>$fservice->slug])}}">
                                    ...
                                    <div class="info-gallery">
                                        ...
                                        <div class="content-btn">
                                            <a href="{{route('home.service_details',['service_slug'=>$fservice->slug])}}" class="btn btn-primary">Book Now</a>
                                        </div>
